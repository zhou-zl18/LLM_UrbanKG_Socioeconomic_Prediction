...
impact_aspects_prompt = kg_info_prompt + """Now we are using this knowledge graph for the "Comments_Prediction" task, i.e., predicting the number of reviews of restaurants on review platform in an urban region. Please help me find some metapaths in this KG which may help this task. 
...
impact_aspects_prompt_jl = kg_info_prompt + """Now we are using this knowledge graph for the "Comments_Prediction" task, i.e., predicting the number of reviews of restaurants on review platform in an urban region. Please help me find some relation paths in this KG which may help this task. 
Since a metapath usually has semantic meaning in the KG, please name each metapath based on its meaning. For example, the metapath (rel_34, rel_33), i.e., Region_NearBy_Region_BorderBy_Region, can be named as 'Geographical Proximity'. Please also provide the reason for why you choose each metapath.
...
impact_aspects_prompt_cl = kg_info_prompt + """Now we are using this knowledge graph for the "Comments_Prediction" task, i.e., predicting the number of reviews of restaurants on review platform in an urban region. Please help me find some relation paths in this KG which may help this task. 
Since a metapath usually has semantic meaning in the KG, please name each metapath based on its meaning. For example, the metapath (rel_34, rel_33), i.e., Region_NearBy_Region_BorderBy_Region, can be named as 'Geographical Proximity'. Please also provide the reason for why you choose each metapath.
