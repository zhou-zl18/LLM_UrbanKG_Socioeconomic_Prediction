...
if __name__ == '__main__':
    ...
    parser.add_argument("--indicator", type=str, default="comments", nargs="?", help="Beijing:pop, orders, eco, rest;Shanghai: pop, eco, comments, rating") ##########################
    ...
    parser.add_argument('--current_task', default='Comments_Prediction', type=str, help='') ##########################
