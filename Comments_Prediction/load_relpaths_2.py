...
class Relpaths:
    def __init__(self, data_dir, all_tasks, current_task, dataset, round):
        ...
        #         "Brand Category Influence":"Region_HasStoreOf_Brand_BelongTo_Category1_HasBrandOf_Brand_ExistIn_POI_LocateAt_Region",
        #         "Regional Business Dynamics":"Region_ServedBy_BusinessArea_Contain_POI_Competitive_POI_LocateAt_Region",
        #         "Population Flow Influence":"Region_PopulationFlowTo_Region_Has_POI_HasCategoryOf_Category1_ExistIn_POI_LocateAt_Region",
        #         "Business and Brand Influence on Reviews":"Region_ServedBy_BusinessArea_Contain_POI_HasBrandOf_Brand_ExistIn_POI_LocateAt_Region",
        #         "Regional Competitive Dynamics":"Region_Has_POI_Competitive_POI_LocateAt_Region",
        #          }
        # shanghai
        metapaths = {
                "Regional Brand Attraction":"Region_HasStoreOf_Brand_BelongTo_Category1_HasBrandOf_Brand_ExistIn_POI_LocateAt_Region",
                "Regional Category Influence":"Region_Has_POI_HasCategoryOf_Category2_IsSubCategoryOf_Category1_ExistIn_POI_LocateAt_Region",
                "Regional Business Dynamics":"Region_ServedBy_BusinessArea_Contain_POI_Competitive_POI_LocateAt_Region",
                "Population-Driven Review Dynamics":"Region_PopulationInflowFrom_Region_Has_POI_HasCategoryOf_Category1_ExistIn_POI_LocateAt_Region",
                "Economic Activity Influence":"Region_Has_POI_HasBrandOf_Brand_HasPlacedStoreAt_Region",
                "Brand Category Influence":"Region_HasStoreOf_Brand_BelongTo_Category1_ExistIn_POI_LocateAt_Region",
                 }
        ...
        metapaths = {
                ...
                "Business Area Impact":"Region_ServedBy_BusinessArea_Contain_POI_LocateAt_Region",
                "Regional Competition":"Region_Has_POI_Competitive_POI_LocateAt_Region",
                 }
