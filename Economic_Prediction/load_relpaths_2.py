...
class Relpaths:
    def __init__(self, data_dir, all_tasks, current_task, dataset, round):
        ...
        # beijing
        # metapaths = {
        #         "Regional Competitive Dynamics":"Region_Has_POI_Competitive_POI_LocateAt_Region",
        #         "Brand and Category Influence":"Region_HasStoreOf_Brand_BelongTo_Category1_HasBrandOf_Brand_HasPlacedStoreAt_Region",
        #         "Geographical and Functional Similarity":"Region_SimilarFunction_Region_NearBy_Region",
        #         "Population-Driven Economic Activity":"Region_PopulationInflowFrom_Region_Has_POI_HasCategoryOf_Category1_ExistIn_POI_LocateAt_Region",
        #         "Culinary Economic Indicator":"Region_Has_POI_HasBrandOf_Brand_BelongTo_Category1_ExistIn_POI_LocateAt_Region",
        #         "Culinary Influence on Economic Activity":"Region_Has_POI_HasBrandOf_Brand_HasPlacedStoreAt_Region",
        #          }
        # shanghai
        metapaths = {
                "Business Area Brand Influence":"Region_ServedBy_BusinessArea_Contain_POI_HasBrandOf_Brand",
                "Regional Competition Impact":"Region_Has_POI_Competitive_POI_LocateAt_Region",
                "Geographical Economic Influence":"Region_NearBy_Region_BorderBy_Region",
                "Population and Economic Activity Link":"Region_PopulationInflowFrom_Region_Has_POI_BelongTo_BusinessArea_Serve_Region",
                "Category and Brand Economic Indicator":"Region_Has_POI_HasCategoryOf_Category1_HasBrandOf_Brand_ExistIn_POI_LocateAt_Region",
                "Regional Economic Indicators":"Region_Has_POI_HasCategoryOf_Category2_HasBrandOf_Brand_ExistIn_POI_LocateAt_Region",
                 }
        
        metapaths = {
                "Regional Economic Connectivity":"Region_BorderBy_Region_Has_POI_LocateAt_Region",
                "Brand and Category Economic Impact":"Region_HasStoreOf_Brand_BelongTo_Category1_ExistIn_POI_LocateAt_Region",
                "Population and Economic Dynamics":"Region_PopulationInflowFrom_Region_Has_POI_BelongTo_BusinessArea",
                "Population and Economic Activity Link":"Region_PopulationInflowFrom_Region_Has_POI_BelongTo_BusinessArea_Serve_Region",
                "Category and Brand Economic Indicator":"Region_Has_POI_HasCategoryOf_Category1_HasBrandOf_Brand_ExistIn_POI_LocateAt_Region",
                "Regional Economic Indicators":"Region_Has_POI_HasCategoryOf_Category2_HasBrandOf_Brand_ExistIn_POI_LocateAt_Region",
                 }
        ...
        # shanghai round 1
        metapaths = {
                "Regional Brand Influence":"Region_HasStoreOf_Brand_ExistIn_POI_LocateAt_Region",
                "Business Area Economic Activity":"Region_ServedBy_BusinessArea_Contain_POI_LocateAt_Region",
                "Population Flow Impact":"Region_PopulationFlowTo_Region_Has_POI",
                 }
