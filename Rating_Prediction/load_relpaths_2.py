...
class Relpaths:
    def __init__(self, data_dir, all_tasks, current_task, dataset, round):
        ...
        # beijing
        # metapaths = {
        #         "Regional Competitive Influence":"Region_Has_POI_Competitive_POI_LocateAt_Region",
        #         "Brand and Category Synergy":"Region_HasStoreOf_Brand_BelongTo_Category2_HasBrandOf_Brand_ExistIn_POI_LocateAt_Region",
        #         "Business Area and Category Dynamics":"Region_ServedBy_BusinessArea_Contain_POI_HasCategoryOf_Category3_IsSubCategoryOf_Category2_ExistIn_POI_LocateAt_Region",
        #         "Population Influence on POIs":"Region_PopulationInflowFrom_Region_Has_POI",
        #         "Economic Activity Influence":"Region_Has_POI_BelongTo_BusinessArea_Serve_Region",
        #         "Brand and Category Synergy":"Region_HasStoreOf_Brand_BelongTo_Category1_ExistIn_POI_LocateAt_Region",
        #          }
        # shanghai
        metapaths = {
                "Brand Relationship Influence":"Region_HasStoreOf_Brand_RelatedBrand_Brand_HasPlacedStoreAt_Region",
                "Competitive Brand Dynamics":"Region_Has_POI_Competitive_POI_HasBrandOf_Brand_HasPlacedStoreAt_Region",
                "Hierarchical Category Influence":"Region_Has_POI_HasCategoryOf_Category3_IsSubCategoryOf_Category2_IsSubCategoryOf_Category1_ExistIn_POI_LocateAt_Region",
                "Competitive Business Dynamics":"Region_ServedBy_BusinessArea_Contain_POI_Competitive_POI_LocateAt_Region",
                "Economic Activity Influence":"Region_Has_POI_HasBrandOf_Brand_BelongTo_Category1_ExistIn_POI_LocateAt_Region",
                "Regional Competitive Dynamics":"Region_Has_POI_Competitive_POI_LocateAt_Region",
                 }
        metapaths = {
                "Regional Category Influenc":"Region_Has_POI_HasCategoryOf_Category2_IsSubCategoryOf_Category1_ExistIn_POI_LocateAt_Region",
                "Brand and Business Area Synergy":"Region_HasStoreOf_Brand_BelongTo_Category1_HasBrandOf_Brand_ExistIn_POI_BelongTo_BusinessArea_Serve_Region",
                "Competitive Dynamics and Regional Influence":"Region_Has_POI_Competitive_POI_HasBrandOf_Brand_HasPlacedStoreAt_Region",
                "Competitive Business Dynamics":"Region_ServedBy_BusinessArea_Contain_POI_Competitive_POI_LocateAt_Region",
                "Economic Activity Influence":"Region_Has_POI_HasBrandOf_Brand_BelongTo_Category1_ExistIn_POI_LocateAt_Region",
                "Regional Competitive Dynamics":"Region_Has_POI_Competitive_POI_LocateAt_Region",
                 }
